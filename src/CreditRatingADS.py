"""
This script runs in full the seventh-place solution to the Home Credit Default Risk
Kaggle challenge.

Found at https://www.kaggle.com/jsaguiar/lightgbm-7th-place-solution
...
# save the csv which is eventually used for training
df.to_csv('../dat/challenge_final_df.csv')
...
if unary_QII:
    # Method to observe  and save potential impact of an individual categorial feature.
    ...
    df['CODE_GENDER'] = aß
    df.to_csv('../dat/challenge_final_df_gender_examined.csv')
    SUBMISSION_SUFIX  = SUBMISSION_SUFIX + "_gender_examined"
with timer("Run LightGBM"):
    feat_importance = kfold_lightgbm_sklearn(df, lgbm_categorical_feat)
    print(feat_importance)
